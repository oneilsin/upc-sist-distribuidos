...
using UPC.Bagueteria.API.Infrastructure;
...
namespace UPC.Bagueteria.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            DBEntity.ConfigSettings config = SectionGet;
            ...
            services.AddAuthentication("Bearer")
                .AddJwtBearer("Bearer", options =>
                {
                    ...
                    options.Audience = "API-BAGUETERIA-UPC";
                });
                ...
                c.SwaggerDoc(
                    ...
                    new OpenApiInfo
                    {
                        ...
                        Contact = new OpenApiContact()
                        {
                            ...
                            Url = new System.Uri("https://www.utp.edu.pe/"),
                            Email = "u201824041@upc.edu.pe",
                        },
                        Description = AppSettingsProvider.config.ApplicationDescription,

                        License = new OpenApiLicense() { Name = AppSettingsProvider.config.OrganizationName, Url = new System.Uri("https://www.utp.edu.pe/") },
                        TermsOfService = new System.Uri("https://www.utp.edu.pe/")
                    });
